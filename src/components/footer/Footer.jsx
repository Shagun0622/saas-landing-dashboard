...
export default function Footer() {
  const sections = {
    column1: [
      { title: 'Home', link: '#' },
      { title: 'Section One', link: '#' },
      { title: 'Section Two', link: '#' },
      { title: 'Section Tree', link: '#' }
    ],
    column2: [
      { title: 'Home', link: '#' },
      { title: 'Section One', link: '#' },
      ...
      <div className="footer-container">
        ...
        <div className="footer-left">
          <div className="footer-logo">
            {/* If you have a logo image, use: <img src={logo} alt="Logo" /> */}
        ...
        <div className="footer-right">
          ...
          <div className="footer-links">
            ...
            <div className="footer-column">
              {sections.column1.map((item, index) => (
            ...
            {/* Column 2 */}
            <div className="footer-column">
              {sections.column2.map((item, index) => (
                <a key={index} href={item.link} className="footer-link">
                  {item.title}
                </a>
              ))}
            ...
            {/* Column 3 */}
            <div className="footer-column">
              {sections.column3.map((item, index) => (
                <a key={index} href={item.link} className="footer-link">
                  {item.title}
                </a>
              ))}
